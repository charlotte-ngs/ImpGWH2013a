...
As we have shown with our timings in the section above, reading data into R does require some time. But still, for reading a dataset in the order of $10^7$ data points requires less than one minute to load seams to be quite acceptable. 
